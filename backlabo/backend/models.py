...
class ChercheurDiplome(models.Model):
    ...
    def __str__(self):
        return f"{self.id_chercheur.nom + " " + self.id_chercheur.prenom} - {self.etablissement}"
...
class ChercheurDomaineExpertise(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_chercheur.nom + " " + self.id_chercheur.prenom , self.id_domaine.titre)
...
class ChercheurMot(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_chercheur.nom + " " + self.id_chercheur.prenom , self.titre)
...
class ChercheurPoste(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_chercheur.nom + " " + self.id_chercheur.prenom , self.id_poste.nom)
...
class ChercheurReseau(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_chercheur.nom + " " + self.id_chercheur.prenom , self.type_reseau)
...
class LaboratoirePageBlockEntete(models.Model):
    ...
    def __str__(self):
        return "{} - {} - {}".format(self.id_laboratoire.nom, self.id_page.titre, self.block)
...
class ChercheurLaboratoire(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_chercheur_poste.id_chercheur.nom + " " + self.id_chercheur_poste.id_chercheur.prenom , self.id_laboratoire.nom)


class LaboratoireDomaine(models.Model):
    LUCIDE_TEACHING_DOMAIN_CHOICES = [
        ("Atom-Science", "Atom-Science"),
        ("Dna-Science", "Dna-Science"),
        ("Brain-Science", "Brain-Science"),
        ("Microscope-Science", "Microscope-Science"),
        ("Cpu-Technologie", "Cpu-Technologie"),
        ("Leaf-Nature", "Leaf-Nature"),
        ("Book-Livre", "Book-Livre"),
        ("BookOpen-Livre", "BookOpen-Livre"),
        ("Globe-Monde", "Globe-Monde"),
        ("Rocket-Science", "Rocket-Science"),
        ("Code-Développement", "Code-Développement"),
        ("Database-Base de données", "Database-Base de données"),
        ("Compass-Orientation", "Compass-Orientation"),
        ("PenTool-Outil", "PenTool-Outil"),
        ("BarChart-Graphique", "BarChart-Graphique"),
        ("PieChart-Graphique", "PieChart-Graphique"),
        ("TestTube-Science", "TestTube-Science"),
        ("GraduationCap-Éducation", "GraduationCap-Éducation"),
        ("Award-Récompense", "Award-Récompense"),
        ("Feather-Plume", "Feather-Plume"),
        ("Camera-Photo", "Camera-Photo"),
        ("Palette-Art", "Palette-Art"),
        ("Music-Musique", "Music-Musique"),
        ("Calculator-Mathématiques", "Calculator-Mathématiques"),
        ("Terminal-Développement", "Terminal-Développement"),
        ("Settings-Paramètres", "Settings-Paramètres"),
        ("User-Utilisateur", "User-Utilisateur"),
        ("Users-Utilisateur", "Users-Utilisateur"),
        ('Shield-Sécurité', 'Shield-Sécurité'),
        ('Zap-Énergie', 'Zap-Énergie'),
    ]


    id_laboratoire = models.ForeignKey(Laboratoire, on_delete=models.CASCADE)
    id_domaine = models.ForeignKey(Domaine , on_delete = models.CASCADE)
    icone = models.CharField(max_length=50, choices=LUCIDE_TEACHING_DOMAIN_CHOICES, default="Atom-Science")
    creer_le = models.DateTimeField(auto_now_add=True)
    mise_a_jour_le = models.DateTimeField(auto_now=True)
...
class LaboratoireNew(models.Model):
    ...
    date_realisation_debut = models.DateField()
    date_realisation_fin = models.DateField(null=True, blank=True)
...
class LaboratoireParcourDeboucher(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_laboratoire_parcour.id_laboratoire.nom , self.deboucher)
...
class LaboratoireParcourSpecialisation(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_laboratoire_parcour.id_laboratoire.nom , self.specialisation)
...
class LaboratoirePartenaire(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_laboratoire.nom , self.id_partenaire.nom_partenaire)
...
class LaboratoireSlider(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_page.titre , self.titre)
...
class LaboratoireNewAlbum(models.Model):
    id_laboratoire_new = models.ForeignKey(LaboratoireNew, on_delete=models.CASCADE)
    ...
    def __str__(self):
        return "{} - {}".format(self.id_laboratoire_new.id_laboratoire.nom, self.image)
...
class RechercheChercheur(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_recherche.titre, self.id_chercheur.nom + " " + self.id_chercheur.prenom)
...
class RechercheChronologie(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_recherche.titre, self.id_recherche_phase.phase)
...
class RechercheLaboratoire(models.Model):
    ...
    def __str__(self):
        return "{} - {} - {}".format(self.id_laboratoire_domaine.id_laboratoire.nom, self.id_recherche.titre, self.id_laboratoire_domaine.id_domaine.titre)
...
class RechercheObjectif(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_recherche.titre, self.objectif)
...
class RecherchePartenaire(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.id_recherche.titre, self.id_partenaire.nom_partenaire)
